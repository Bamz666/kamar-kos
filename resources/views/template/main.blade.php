...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('vendor') }}/img/logokos.png">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-12 col-lg-8">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-phone"></i> +62881410546486</a></li>
                                    <li><a href="#"> <i class="fa fa-envelope"></i>km.kos666@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{ asset('vendor')}}/img/logokos.png" alt="logo_kos"
                                        style="width: 21%; height: 14%; mix-blend-mode: darken;">
                                </a>
                                <a class="navbar-brand text-dark" href="#">Kamar<span>Kos</span>.</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            <div class="footer_logo" style="margin-top: -5%;">
                                <img src="{{ asset('vendor')}}/img/logokos.png" alt="logo_kos"
                                    style="width: 25%; height: 20%; mix-blend-mode: darken;">
                                <a class="navbar-brand text-dark" href="#">Kamar<span>Kos</span>.</a>
                            </div>
                            <div class="row">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.7117202492464!2d106.81653397594468!3d-6.301558361674517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed44c9532647%3A0x5589ddd11d4aa627!2sEnigma%20Camp!5e0!3m2!1sid!2sid!4v1704293745196!5m2!1sid!2sid" width="350" height="250" style="border:0; margin-top:-1rem" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <div class="contacts">
                                <p>+62881410546486 <br>
                                    km.kos666@gmail.com<br>
                                    Jl. Dahlan No.11A, Ragunan, Jakarta Barat 10320
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="news_links">
                                @foreach(\App\Models\KamarKos::orderBy("id_nama","desc")->skip(0)->take(3)->get() as $index => $row)
                                <li>
                                    <div class="thumb">
                                        <a href="{{ route('show',$row->id_nama)}}">
                            <img src="{{ asset('upload/'.$row['gambar_utama'])}}" alt="" style="aspect-ratio: 3/2;">
                                        </a>
                                    </div>
                                    <div class="info">
                                        <a href="{{ route('show',$row->id_nama)}}">
                    ...
                    <div class="col-xl-12">
                        ...
                        <p>
                            ...
                            <script>document.write(new Date().getFullYear());</script> All rights reserved | <a
                                ...
                                style="font-size: 1rem;">Kamar<span>Kos</span>.</a>
                        </p>
                        </p>
                    </div>
                </div>
