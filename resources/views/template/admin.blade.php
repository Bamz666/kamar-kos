...
<head>
	...
	<link rel="icon" href="{{ asset('vendor') }}/img/logokos.png" type="image/x-icon"/>
		...
		<div class="main-header">
			...
			<div class="logo-header">
				...
				<a href="index.html" class="logo">
					<img src="{{ asset('vendor') }}/img/logokos.png" alt="navbar brand" class="navbar-brand"
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="{{ asset('vendor') }}/img/logokos.png" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="{{ asset('vendor') }}/img/logokos.png" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
									...
									<li>
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="{{ route('awal')}}">Home</a>
										<div class="dropdown-divider"></div>
